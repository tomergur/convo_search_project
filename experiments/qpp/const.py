...
QPP_FEATURES_PARAMS={"WIG":[{"k":v} for v in K_VALS],
                     ...
                     "ref_rewrites_NQC_norm": [{"k": k, "n": n, "lambd": lambd} for k, n, lambd in
                                          itertools.product(K_VALS, RBO_N_VALS, LAMBD_VALS)],
                     "bert_qpp_cls": [{"suffix":v} for v in ["_v3","_v4"]],
                     "bert_qpp_reg": [{"suffix":v} for v in ["_v7", "_v8"]],
                     "bert_qpp_hp": [{"suffix": v} for v in ["_v3","_v4","_v7", "_v8"]],
                     "many_turns_bert_qpp_cls": [{"suffix": v} for v in ["_v3", "_v4"]],
                     "many_turns_bert_qpp_2cls": [{"suffix": v} for v in ["_v7", "_v8"]],
                     "many_turns_bert_qpp_reg": [{"suffix": v} for v in ["_v11", "_v12"]],
